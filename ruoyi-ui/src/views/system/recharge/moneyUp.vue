...
<!--        </el-form-item>-->
      ...
      <el-row :gutter="20">
        <el-form-item label="加款金额" prop="cashMoney">
          <el-input
      ...
      <el-form-item>
        <el-button type="success" icon="el-icon-edit" size="mini" @click="recharge">保存</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  methods: {
    ...
    recharge(){
      this.$refs["queryForm"].validate(valid => {
        if(valid){
          adminRecharge(this.queryParams).then(response => {
