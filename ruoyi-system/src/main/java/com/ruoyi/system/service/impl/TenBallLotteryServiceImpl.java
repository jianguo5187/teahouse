...
public class TenBallLotteryServiceImpl implements ITenBallLotteryService {
    ...
    //            throw new ServiceException("createTenballData return false4");
            ...
            newGameTenballKj.setCreateBy("createTenballData1");
            ...
            for(int i=1;i<=periodsSize;i++){
                ...
                if(gameTenballKj == null){
                    ...
                    newGameTenballKj.setGameName(gameInfo.getGameName());
                    newGameTenballKj.setStatus("0");
                    newGameTenballKj.setCreateBy("createFiveBallData2");
                    ...
                    newGameTenballKj.setCreateBy("createTenballData2");
                    gameTenballKjService.insertGameTenballKj(newGameTenballKj);
                }
            }
        }
    ...
    public void CreateTenballAll(SysGame gameInfo){
        ...
        for(GameTenballOpenData gmeTenballOpenData :gameTenballOpenDataList){
            ...
            newGameTenballKj.setCreateBy("createTenballData3");
            gameTenballKjService.insertGameTenballKj(newGameTenballKj);
        }
                ...
                if (StringUtils.isNotEmpty(gameWinFlg) && Boolean.parseBoolean(gameWinFlg)) {
                    ...
                    for(BetRecord betRecord : betRecordList){
                        ...
                        if(StringUtils.equals("大",betRecord.getBetNumber())){
                            ...
                            //  猜第四名
                            bets.add(new OptimalBetRecord(betRecord.getUserId() + ""
                                    ,OptimalBetRecord.BetType.FOURTH_PLACE_NUMBER
                                    ,Integer.valueOf(betRecord.getBetNumber())
                                    ,betRecord.getMoney()
                                    ,getOddFromMapByOddKey(betItemMap,"num4Under" + (position))));
                        }else if(position == 5){
                            //  猜第五名
                            bets.add(new OptimalBetRecord(betRecord.getUserId() + ""
                                    ,OptimalBetRecord.BetType.FIFTH_PLACE_NUMBER
                                    ,Integer.valueOf(betRecord.getBetNumber())
                                    ,betRecord.getMoney()
                                    ,getOddFromMapByOddKey(betItemMap,"num5Under" + (position))));
                        }else if(position == 6){
                            //  猜第六名
                            bets.add(new OptimalBetRecord(betRecord.getUserId() + ""
                                    ,OptimalBetRecord.BetType.SIXTH_PLACE_NUMBER
                                    ,Integer.valueOf(betRecord.getBetNumber())
                                    ,betRecord.getMoney()
                                    ,getOddFromMapByOddKey(betItemMap,"num6Under" + (position))));
                        }else if(position == 7){
                            //  猜第七名
                            bets.add(new OptimalBetRecord(betRecord.getUserId() + ""
                                    ,OptimalBetRecord.BetType.SEVENTH_PLACE_NUMBER
                                    ,Integer.valueOf(betRecord.getBetNumber())
                                    ,betRecord.getMoney()
                                    ,getOddFromMapByOddKey(betItemMap,"num7Under" + (position))));
                        }else if(position == 8){
                            //  猜第八名
                            bets.add(new OptimalBetRecord(betRecord.getUserId() + ""
                                    ,OptimalBetRecord.BetType.EIGHTH_PLACE_NUMBER
                                    ,Integer.valueOf(betRecord.getBetNumber())
                                    ,betRecord.getMoney()
                                    ,getOddFromMapByOddKey(betItemMap,"num8Under" + (position))));
                        }else if(position == 9){
                            //  猜第九名
                            bets.add(new OptimalBetRecord(betRecord.getUserId() + ""
                                    ,OptimalBetRecord.BetType.NINTH_PLACE_NUMBER
                                    ,Integer.valueOf(betRecord.getBetNumber())
                                    ,betRecord.getMoney()
                                    ,getOddFromMapByOddKey(betItemMap,"num9Under" + (position))));
                        }else if(position == 10){
                            //  猜第十名
                            bets.add(new OptimalBetRecord(betRecord.getUserId() + ""
                                    ,OptimalBetRecord.BetType.TENTH_PLACE_NUMBER
                                    ,Integer.valueOf(betRecord.getBetNumber())
                                    ,betRecord.getMoney()
                                    ,getOddFromMapByOddKey(betItemMap,"num10Under" + (position))));
                        }
                    }
